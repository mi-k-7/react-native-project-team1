...
const Page7 = ({ next, back }) => {
  ...
  const icons = [
    { id: 1, source: require("../../../assets/Page7-sunny.png") },
    { id: 2, source: require("../../../assets/Page7-cloudy.png") },
    { id: 3, source: require("../../../assets/Page7-rainy.png") },
    { id: 4, source: require("../../../assets/Page7-snowy.png") },
  ];

  const weatherIcons = [
    { id: 1, name: "맑음", source: require("../../../assets/Page7-sunny.png") },
    { id: 2, name: "흐림", source: require("../../../assets/Page7-cloudy.png") },
    { id: 3, name: "비", source: require("../../../assets/Page7-rainy.png") },
    { id: 4, name: "눈", source: require("../../../assets/Page7-snowy.png") },
  ];
